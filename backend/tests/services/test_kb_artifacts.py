...
# NOTE: TestCorpusKgEndpoint and TestPapersGraphEndpoint were removed in the
# wake of Issue #382 (papers_routes.py legacy /corpus/* endpoints deleted —
# canonical surface is /api/corpus/* via corpus_routes.py, which has its own
# coverage in test_corpus_routes.py).
